...
class DbusGroMODService:
    def __init__(self, servicename, settings, paths, data_connector, serialnumber='X',
        ...
        # productname="Growatt MOD" #tmp please del
...
def main():
    ...
    try:
        ...
        pvac_output = DbusGroMODService(
            servicename='com.victronenergy.pvinverter.GroMOD',
            settings=settings,
            paths=dbuspath,
